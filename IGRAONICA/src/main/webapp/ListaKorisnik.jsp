...
<div class="about-div">
	<% ArrayList<Korisnik> korisniks=(ArrayList<Korisnik>)request.getAttribute("Korisnici"); %>
</div>
		...
		<table>
			...
			<% for(Korisnik pom:korisniks){
				...
				<tr>
					...
					<td><%=pom.getEmail() %></td>
					<td><%=pom.getPoints() %></td>
					<td><a href="AdminObrisiKorisnika?id=<%=pom.getId() %>">Obrisi</a></td>
				</tr>
			<% } %>
		</table>
	</div>	
