...
<section id="menu" class="fix-slika-menu">
	<div class="menu-text">
		...
		<hr>
		<p class="p-text">Lista nasih dogadjaja, opcija i paketa koje mozete rezervisati.</p>
	</div>
	<div class="menu-menu">
		<div class="breakfast">
...
<section id="gallery" class="fix-slika-gallery">
	<div class="menu-text">
		...
		<hr>
		<p class="p-text">Galerija slika nasih igraonica</p>
	</div>
...
<section id="contact" class="reservation">
	<div class="number-res">
		<h2 class="h2-res">ZELITE DA NAPRAVITE REZERVACIJU? POZOVITE <strong>+381 645472355</strong></h2>
	</div>
</section>
