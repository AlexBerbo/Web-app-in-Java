...
<% ArrayList<Igraonica>igraonicas=(ArrayList<Igraonica>)request.getAttribute("igraonica"); %>
...
<header class="header">
		...
		<ul>
			...
			<li>
				<a class="nav-bar" href="InfoIgraonice">Lista paketa i rezervacija</a>
			</li>
			<li>
...
<section id="login" class="login-section">
	<div class="login-div">
		<form action="DodajPaket" method="post">
		<br><br><br><br>
		...
		<h2>DODAJ PAKET</h2>
			...
			<p>Bodovi: <input type="text" name="bodovi"/></p>
			<select name="igraonica">
     			<% for(Igraonica pom: igraonicas){
     				%>
    			<option value=<%=pom.getIdigraonica() %>><%=pom.getNaziv() %></option>
    			<%	} %>
			</select>
