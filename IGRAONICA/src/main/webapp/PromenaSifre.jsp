...
<section id="login" class="login-section">
	<div class="login-div">
		<form action="PromeniSifru" method="post">
		<h1>${(poruka!=null) ? poruka : "Dobrodosli, ovde mozete promeniti sifru!"}</h1>
		<h2>PROMENA SIFRE</h2>
			<hr>
			<p>Username: <input type="text" name="username1" value="${korisnik.username}"/></p>
			<p>Novi password: <input type="password" name="password1"/></p>
			<p>Potvrdi password: <input type="password" name="password2"/></p>
